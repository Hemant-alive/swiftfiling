...
class PackageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($success == 1){
            ...
            return redirect(url('admin/package/'.$insertedId.'/edit'));   
        }else{
    ...
    public function show($id)
    {
        ...
        $plans = DB::table('plans')
                ->select('title')
                ->where('id',$package->plan_id)
                ->first();

        return view('admin.package.view')->with(['plans'=> $plans,'package'=> $package,'id'=>$id]);
    ...
    public function edit($id)
    {
        ...
        $plans = DB::table('plans')
                ...
                ->get()
                ->toArray();
        return view('admin.package.edit')->with(['plans'=> $plans,'package'=> $package,'id'=>$id]);
    }
