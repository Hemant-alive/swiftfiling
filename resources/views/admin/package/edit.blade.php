                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="horizontal-form">
                            ...
                            <?php /*<div class="form-group">
                               ...
                               <div class="col-sm-2">
                                    <input type="text" name="state_fees" id="state_fees" class="form-control" value="{!! $package->state_fees;!!}" placeholder="State fees" disabled="disabled">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input class="date form-control" type="text" value="{{ $package->start_date }}" name="start_date" readonly="true" placeholder="click this box for the Choose the Date">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">End Date</label>
                                <div class="col-sm-8">
                                    <input class="date form-control" type="text" value="{{ $package->end_date }}" name="end_date"  readonly="true" placeholder="click this box for the Choose the Date">
                                </div>
                            </div>
                            <div class="form-group">
