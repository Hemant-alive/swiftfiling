...
@section('body')
    <div id="page-wrapper">
        <div class="graphs">
            <h3 class="blank1">New Package</h3>
            <hr>

        {!! Form::open(array('url' => 'admin/package/','method' => 'post','class'=>'form-horizontal','id'=>'NewPackage')) !!}
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="horizontal-form">
                           ...
                           <?php /*<div class="form-group">
                               ...
                               <div class="col-sm-2">
                                    <input type="text" name="state_fees" id="state_fees" class="form-control" value="{{old( 'state_fees')? old( 'state_fees') : 0}}" placeholder="State fees" disabled="disabled">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input class="date form-control" type="text" name="start_date" readonly="true" placeholder="click this box for the Choose the Date">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">End Date</label>
                                <div class="col-sm-8">
                                    <input class="date form-control" type="text" name="end_date"  readonly="true" placeholder="click this box for the Choose the Date">
                                </div>
                            </div>
                            <div class="form-group">
