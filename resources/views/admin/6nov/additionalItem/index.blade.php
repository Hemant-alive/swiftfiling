        ...
        <div class="grid_3 fulldiv pd10 m0">
            <div class="row">
                    ...
                    <div class="col-sm-2 grid_box1"> 
                        ...
                        <input type="text" name="name" value="{{Session::has('search_title')? Session::get('search_title') : old('title')}}" class="form-control1 input-sm" placeholder="Title">
                    </div>
                    <div class="col-sm-2 grid_box1">
                        ...
                        <tbody> 
                            ...
                            <?php if(isset($page)) $i=$page['from']; else $i=1; ?> @foreach($items as $item)
                                <tr>
                                    ...
                                    <td> <a href="{{URL :: asset('admin/additional-item/'.$item->id)}}" class="btn btn-success" title='edit'><i class="fa fa-edit"></i></a>
