                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="horizontal-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="price" id="price" class="form-control1" value="{{old('price')}}">
                                     @if ($errors->has('price'))
                            ...
                            <div class="form-group">
                               ...
                               <div class="col-sm-2">
                                    <input type="text" name="state_fees" id="state_fees" class="form-control1" value="{{old( 'state_fees')? old( 'state_fees') : 0}}" placeholder="State fees" disabled="disabled">
